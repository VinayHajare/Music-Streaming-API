...
public class MusicDiscoveryController {
	...
	public ResponseEntity<String> followArtist(@RequestParam String username,
		...
		}catch (UsernameNotFoundException | ArtistNotFoundException e) {
			return ResponseEntity.notFound().build();
		}
	}
	
	@DeleteMapping("/unFollowArtist")
	public ResponseEntity<String> unFollowArtist(@RequestParam String username,
												 @RequestParam Long artistId) {
		try {
